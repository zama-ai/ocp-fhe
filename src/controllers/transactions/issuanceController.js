...
// Stock Issuance
export const convertAndCreateIssuanceStockOnchain = async (contract, { security_id, stock_class_id, stakeholder_id, quantity, share_price }) => {
...
export const convertAndCreateIssuanceConvertibleOnchain = async (contract, { security_id, stakeholder_id, investment_amount }) => {
    const stakeholderIdBytes16 = convertUUIDToBytes16(stakeholder_id);
    const securityIdBytes16 = convertUUIDToBytes16(security_id);
