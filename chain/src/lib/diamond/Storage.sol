...
import { StockActivePositions, ConvertibleActivePositions, EquityCompensationActivePositions, WarrantActivePositions, Issuer, StockClass, StockPlan } from "./Structs.sol";
struct Storage {
    Issuer issuer;
